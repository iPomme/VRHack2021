...
public class AvatarSelectionManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (PhotonNetwork.LocalPlayer.CustomProperties.TryGetValue(MultiplayerVRConstant.AVATAR_SELECTION_NUMBER, out storedAvatarSelectionNumber))
        {
    ...
    private void LoadAvatarModelAt(int avatarIndex)
    {
        ...
        ExitGames.Client.Photon.Hashtable playerSelectionProp = new ExitGames.Client.Photon.Hashtable() { {MultiplayerVRConstant.AVATAR_SELECTION_NUMBER,avatarSelectionNumber } };
